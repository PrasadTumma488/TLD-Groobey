      ...
      >
        {preview ?
          <>
            ...
            {showCustomerEmail ?
              <motion className="groobey-bill-preview-email-bar shrink-0 border-t border-border bg-card px-4 py-3 sm:px-5">
            ...
            {showSettlementEmail ?
              <motion
                className={cn(
                  "groobey-bill-preview-email-bar shrink-0 border-t border-border px-4 py-3 sm:px-5",
                  "bg-amber-50/80",
                )}
              >
                <GroobeyBillEmailSendField
